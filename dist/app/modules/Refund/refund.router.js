...
router.post('/send-refund-request', auth("player", "admin"), refundController.sendRefundRequest);
...
router.put("/exit-lobby", auth("player", "admin"), refundController.exit_lobby);

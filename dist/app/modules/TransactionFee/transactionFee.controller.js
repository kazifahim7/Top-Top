...
const getGlobalSetting = catchAsync(async (_req, res) => {
...
const createGlobalSetting = catchAsync(async (req, res) => {
...
const getCountryFees = catchAsync(async (req, res) => {
...
const updateCountryFixedFee = catchAsync(async (req, res) => {
...
const getQuote = catchAsync(async (req, res) => {
    const result = await TransactionFeeService.buildQuote(req.query);
    res.status(200).json({
        success: true,
...
//# sourceMappingURL=transactionFee.controller.js.map
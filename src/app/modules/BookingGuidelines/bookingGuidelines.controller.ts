...
const getGlobalGuidelines = catchAsync(async (_req: Request, res: Response) => {
...
const createGlobalGuidelines = catchAsync(async (req: Request, res: Response) => {
...
const updateGlobalGuidelines = catchAsync(async (req: Request, res: Response) => {
